...
@section('title', 'تعديل بيانات القسم الطبي')
...
<div class="dashboard-header" style="max-width: 800px; margin-left: auto; margin-right: auto;">
    <div class="welcome-text">
        <h1>تعديل القسم الطبي: {{ $department->name }}</h1>
    </div>
</div>

<div class="card-section">
    <form action="{{ route('doctor.clinical.departments.update', $department->id) }}" method="POST">
        @csrf
        @method('PUT')
