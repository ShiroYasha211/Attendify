...
@section('title', 'إدارة الأجهزة المرضية')
...
<form action="{{ route('doctor.clinical.body-systems.index') }}" method="GET" class="filter-bar">
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" stroke-width="2">
        <circle cx="11" cy="11" r="8"></circle>
        <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
    </svg>
    <input type="text" name="search" value="{{ request('search') }}" placeholder="ابحث باسم الجهاز المرضي...">
    <button type="submit" class="btn-filter">بحث</button>
    @if(request('search'))<a href="{{ route('doctor.clinical.body-systems.index') }}" class="btn-filter-reset">إلغاء</a>@endif
</form>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        ...
                        <form action="{{ route('doctor.clinical.body-systems.destroy', $system->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('هل أنت متأكد من مسح هذا الجهاز؟')">
                            @csrf @method('DELETE')
                ...
                <tr>
                    <td colspan="4" style="text-align:center; color:var(--text-secondary); padding:3rem 1rem;">
                        <p>لا يوجد أجهزة مرضية مضافة حالياً.</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
