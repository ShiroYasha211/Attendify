    ...
    <div class="card" style="max-width: 600px; margin: 0 auto;">
        ...
        <form action="{{ route('admin.students.store') }}" method="POST">
            ...
            <div style="margin-bottom: 1rem;">
                <label style="display: block; margin-bottom: 0.5rem; font-weight: bold;">الرقم الجامعي <span style="color: red">*</span></label>
                <input type="text" name="student_number" required value="{{ old('student_number') }}" style="width: 100%; padding: 0.5rem; border: 1px solid #ced4da; border-radius: 4px;">
            </div>
            ...
            <div style="margin-bottom: 1.5rem;">
                <label style="display: block; margin-bottom: 0.5rem; font-weight: bold;">المستوى الدراسي <span style="color: red">*</span></label>
                ...
                <small style="color: #666; display: block; margin-top: 0.25rem;">سيتم تسجيل الطالب في الكلية والتخصص التابعين لهذا المستوى.</small>
            </div>
            ...
            <div style="display: flex; gap: 1rem;">
                ...
                <a href="{{ route('admin.students.index') }}" style="flex: 1; text-align: center; background: #e2e6ea; color: #495057; text-decoration: none; padding: 0.75rem; border-radius: 4px; font-size: 1rem;">
                    إلغاء
                </a>
            </div>
        </form>
