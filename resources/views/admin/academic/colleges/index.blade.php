...
<div x-data="{ 
    ...
    <div class="page-header">
        ...
        <div class="page-header-text">
            <h1>إدارة الكليات</h1>
            <p>إضافة وتعديل الكليات التابعة للجامعات</p>
        </div>
    </div>
    ...
    <div class="stats-row">
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3>{{ $colleges->sum(fn($c) => $c->majors->count()) }}</h3>
                <p>إجمالي التخصصات</p>
            </div>
        </div>
    </div>
    ...
    <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 1.5rem; align-items: start;">
        ...
        <div class="table-card">
            <div class="table-card-header">
                ...
                <span class="count-badge">{{ $colleges->count() }} كلية</span>
            </div>
...
<table class="modern-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge badge-info">{{ $college->majors->count() }} تخصص</span>
                        </td>
                        <td>
                            <div style="display: flex; gap: 0.5rem;">
                                ...
                                <button type="button" class="action-btn delete"
                                    @click="
                                        ...
                                        modalTitle = 'حذف {{ $college->name }}';
                                        modalMessage = 'سيؤدي حذف الكلية إلى حذف جميع التخصصات ({{ $college->majors->count() }}) والطلاب والمواد المرتبطة.';
                                    ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <tr>
                        <td colspan="5" style="text-align: center; padding: 3rem; color: var(--text-secondary);">
                            ...
                            <div>لا توجد كليات مضافة حتى الآن</div>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
