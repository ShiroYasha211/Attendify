...
<div class="clinical-page-header">
    <div class="right-side">
        ...
        <p>{{ $evaluation->checklist->title ?? '-' }} — د. {{ $evaluation->doctor->name ?? '-' }}</p>
    </div>
    <div class="left-side"><a href="{{ route('student.clinical.evaluations') }}" class="btn-back"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
