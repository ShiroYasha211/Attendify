...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        <div>
            ...
            <p class="text-secondary mb-0 fw-bold small">أنشئ حزمة جديدة وخصص إعدادات الإشعارات الذكية</p>
        </div>
        <a href="{{ route('student.flashcards.index') }}" class="btn btn-light fw-bold rounded-3 px-3 py-2 shadow-sm border d-inline-flex align-items-center gap-2">
                ...
                <div class="card border-0 shadow-sm rounded-5 p-4 p-md-5 bg-white h-100">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" rows="2" 
                                  ...
                                  placeholder="اكتب وصفاً ليساعدك على تذكر هدف الحزمة...">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <select name="display_mode" required class="form-select border-2 bg-light rounded-4 fw-bold shadow-none p-3">
                                <option value="flash_card" {{ old('display_mode') == 'flash_card' ? 'selected' : '' }}>بطاقة (وجهين)</option>
                                <option value="one_line" {{ old('display_mode') == 'one_line' ? 'selected' : '' }}>نص واحد (إشعار)</option>
                                <option value="qa" {{ old('display_mode') == 'qa' ? 'selected' : '' }}>سؤال وجواب</option>
                                <option value="mcq" {{ old('display_mode') == 'mcq' ? 'selected' : '' }}>اختيار من متعدد</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            ...
                            <select name="repeat_cycle" required class="form-select border-2 bg-light rounded-4 fw-bold shadow-none p-3">
                                <option value="daily" {{ old('repeat_cycle', 'daily') == 'daily' ? 'selected' : '' }}>يومي</option>
                                <option value="weekly" {{ old('repeat_cycle') == 'weekly' ? 'selected' : '' }}>أسبوعي</option>
                                <option value="monthly" {{ old('repeat_cycle') == 'monthly' ? 'selected' : '' }}>شهري</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" name="daily_notification_count" value="{{ old('daily_notification_count', 5) }}" min="1" max="50"
                ...
                <div class="d-flex flex-column gap-4 h-100">
                    <div class="card border-0 shadow-sm rounded-5 p-4 bg-white">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" name="quiet_start" value="{{ old('quiet_start', '23:00') }}"
                        ...
                        <div class="mb-0">
                            ...
                            <input type="time" name="quiet_end" value="{{ old('quiet_end', '07:00') }}"
                                   class="form-control border-2 bg-light rounded-3 fw-bold shadow-none">
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm rounded-5 p-4 bg-white">
                        <div class="form-check form-switch p-0 d-flex align-items-center justify-content-between">
                            ...
                            <input class="form-check-input ms-0 border-0 shadow-none bg-secondary" type="checkbox" role="switch" id="notifySwitch" 
                                   name="notifications_enabled" value="1" {{ old('notifications_enabled', 1) ? 'checked' : '' }}
